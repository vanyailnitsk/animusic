...
import animusic.conf.properties.ProfilesConfiguration;
...
@EnableJpaRepositories(basePackages = "animusic.core.db.table")
@EntityScan(basePackages = {"animusic.core.db.model"})
